...
class TodoItemsControllerTest < ActionController::TestCase
  ...
  test "should create todo_item" do
    assert_difference('TodoItem.count') do
      post :create, todo_item: { due_at: @todo_item.due_at, title: @todo_item.title, todo_list_id: @todo_item.todo_list_id }
    end
  ...
  test "should update todo_item" do
    patch :update, id: @todo_item, todo_item: { due_at: @todo_item.due_at, title: @todo_item.title, todo_list_id: @todo_item.todo_list_id }
    assert_redirected_to todo_item_path(assigns(:todo_item))
  end
